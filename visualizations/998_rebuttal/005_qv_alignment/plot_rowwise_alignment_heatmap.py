"""Render the complete mean matching-row Euclidean QV-alignment heatmap."""
...
def main() -> None:
    ...
    tasks, cosine = matrix_from_records(data, "cosine")
    ...
    ax.set_xlabel("Receiver task")
    ax.set_ylabel("Donor task")
    ax.set_title(
        "Mean matching-row Euclidean alignment of quantized-Linear QVs\n"
    ...
    outputs = save_figure(fig, output_dir, "rowwise_alignment_heatmap")
    plt.close(fig)
