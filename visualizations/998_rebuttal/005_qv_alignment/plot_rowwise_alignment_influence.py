"""Render unchanged leave-one-task-out robustness for row-wise alignment."""
...
def main() -> None:
    ...
    fig, axes = plt.subplots(
        1, 2, figsize=(10.8, 7.4), sharex=True, constrained_layout=True
    )
    ...
    fig.suptitle(
        "Influence sensitivity of mean row cosine versus unit-scale transfer gain\n"
    ...
    outputs = save_figure(fig, output_dir, "rowwise_alignment_influence")
    plt.close(fig)
