"""Render the complete signed Euclidean QV-alignment heatmap."""
...
def main() -> None:
    ...
    ax.set_title(
        "Global Euclidean alignment of quantized-Linear QVs\n"
    ...
    outputs = save_figure(fig, output_dir, "alignment_heatmap")
    plt.close(fig)
