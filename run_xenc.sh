...
say "START $NAME (gpu $PHYS, cross-encoder $DS W$BITS)"
./.venv/bin/python code/experiments/text/sentence_transformers/004_input_fragility/crossencoder_gap_profile.py \
