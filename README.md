...
## Visualizations of REx
  ...
  uv run --active python code/experiments/vision/rex/rex_transfer.py --config-path ../../../../config/experiments/vision/rex --config-name rex_transfer model_family=ilharco_hf_clip model_name=openai/clip-vit-base-patch16 source.dataset_names=[CIFAR10] target.dataset_names=[CIFAR10] source.seed=2038 target.seed=2038 alphas=[0.5,1.0] limit_num_batches=1 rex.bits=4 rex.order=2 rex.sparsity=0.5 rex.granularity=channel 'rex.skip_modules=[classification_head]' ptq.bits=4 ptq.granularity=channel 'ptq.skip_modules=[classification_head]' batch_size=128 lr=1e-5 wd=0.1 ls=0.0 wl=500 max_grad_norm=1.0

  uv run --active python code/experiments/vision/rex/rex_transfer.py --config-path ../../../../config/experiments/vision/rex --config-name rex_transfer model_family=ilharco_hf_clip model_name=openai/clip-vit-base-patch16 source.dataset_names=["Cars","CIFAR10","DTD","EuroSAT","GTSRB","MNIST","RESISC45","SUN397","SVHN","CIFAR100","STL10","Food101","Flowers102","FER2013","PCAM","OxfordIIITPet","RenderedSST2","EMNIST","FashionMNIST","KMNIST","TinyImageNet","ImageNet"] target.dataset_names=["Cars","CIFAR10","DTD","EuroSAT","GTSRB","MNIST","RESISC45","SUN397","SVHN","CIFAR100","STL10","Food101","Flowers102","FER2013","PCAM","OxfordIIITPet","RenderedSST2","EMNIST","FashionMNIST","KMNIST","TinyImageNet","ImageNet"] source.seed=2038 target.seed=2038 alphas=[0.1,0.3,0.5,0.7,1.0] rex.bits=4 rex.order=2 rex.sparsity=0.5 rex.granularity=channel 'rex.skip_modules=[classification_head]' ptq.bits=4 ptq.granularity=channel 'ptq.skip_modules=[classification_head]' batch_size=128 lr=1e-5 wd=0.1 ls=0.0 wl=500 max_grad_norm=1.0

  uv run --active python code/experiments/vision/rex/rex_transfer.py --config-path ../../../../config/experiments/vision/rex --config-name rex_transfer model_family=ilharco_timm_supervised model_name=vit_base_patch16_224.augreg2_in21k_ft_in1k source.dataset_names=["Cars","CIFAR10","DTD","EuroSAT","GTSRB","MNIST","RESISC45","SUN397","SVHN","CIFAR100","STL10","Food101","Flowers102","FER2013","PCAM","OxfordIIITPet","RenderedSST2","EMNIST","FashionMNIST","KMNIST","TinyImageNet","ImageNet"] target.dataset_names=["Cars","CIFAR10","DTD","EuroSAT","GTSRB","MNIST","RESISC45","SUN397","SVHN","CIFAR100","STL10","Food101","Flowers102","FER2013","PCAM","OxfordIIITPet","RenderedSST2","EMNIST","FashionMNIST","KMNIST","TinyImageNet","ImageNet"] source.seed=2038 target.seed=2038 alphas=[1.0] rex.bits=4 rex.order=2 rex.sparsity=0.5 rex.granularity=channel 'rex.skip_modules=[head]' ptq.bits=4 ptq.granularity=channel 'ptq.skip_modules=[head]' batch_size=128 lr=1e-5 wd=0.1 ls=0.0 wl=500 max_grad_norm=1.0

uv run --active python code/experiments/vision/rex/rex_transfer.py --config-path ../../../../config/experiments/vision/rex --config-name rex_transfer model_family=ilharco_timm_supervised model_name=vit_base_patch16_224.augreg2_in21k_ft_in1k source.dataset_names=["Cars","CIFAR10","DTD","EuroSAT","GTSRB","MNIST","RESISC45","SUN397","SVHN","CIFAR100","STL10","Food101","Flowers102","FER2013","PCAM","OxfordIIITPet","RenderedSST2","EMNIST","FashionMNIST","KMNIST","TinyImageNet","ImageNet"] target.dataset_names=["Cars","CIFAR10","DTD","EuroSAT","GTSRB","MNIST","RESISC45","SUN397","SVHN","CIFAR100","STL10","Food101","Flowers102","FER2013","PCAM","OxfordIIITPet","RenderedSST2","EMNIST","FashionMNIST","KMNIST","TinyImageNet","ImageNet"] source.seed=2038 target.seed=2038 alphas=[1.0] rex.bits=3 rex.order=2 rex.sparsity=0.5 rex.granularity=channel 'rex.skip_modules=[head]' ptq.bits=3 ptq.granularity=channel 'ptq.skip_modules=[head]' batch_size=128 lr=1e-5 wd=0.1 ls=0.0 wl=500 max_grad_norm=1.0

uv run --active python -m py_compile code/visualizations/vision/rex/rex_transfer_heatmap.py && uv run --active python code/visualizations/vision/rex/rex_transfer_heatmap.py --model-name vit_base_patch16_224.augreg2_in21k_ft_in1k --seed 2038 --optim adamw --lr 1e-5 --wd 0.1 --ls 0.0 --wl 500 --max-grad-norm 1.0 --batch-size 128 --rex-bits 4 --rex-order 2 --rex-sparsity 0.5 --rex-granularity channel --rex-skip-modules head --ptq-bits 4 --ptq-granularity channel --ptq-skip-modules head --alphas 0.5 1.0 --evaluation-root quantization/qat-transfer/evaluations/vision/rex_transfer/ilharco_timm_supervised && git --no-pager status --short