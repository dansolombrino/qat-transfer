#!/usr/bin/env bash
# wave 20260802-212527; behemoth GPU 4; user-approved behemoth set 0,2,4,5,6,7
set -u
...
failures=0
completed=0
total=$(wc -l < "$SCRIPT_DIR/behemoth_gpu4.manifest")
...
done < "$SCRIPT_DIR/behemoth_gpu4.manifest"
