#!/usr/bin/env bash
# wave 20260804-134500; behemoth GPU 5; user-approved behemoth set 0,2,4,5,6,7
set -u
...
MANIFEST="$SCRIPT_DIR/behemoth_gpu5.manifest"
FAILURES="$SCRIPT_DIR/behemoth_gpu5.failures"
: > "$FAILURES"
failures=0
completed=0
total=19
