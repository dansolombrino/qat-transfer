#!/usr/bin/env bash
# run: model=vit_base_patch16_224_orig_in21k,src=CIFAR10-seed2038,tgt=GTSRB-seed2038,optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128,qat=b3-gchannel-shead,awq=b3-gchannel-shead-n4-grid20-clip1,qv=a1.0,split=test   experiment: vision/ilharco_timm_supervised/009_qat_transfer_awq
...
RUN_ID_FLAT=model=vit_base_patch16_224_orig_in21k,src=CIFAR10-seed2038,tgt=GTSRB-seed2038,optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128,qat=b3-gchannel-shead,awq=b3-gchannel-shead-n4-grid20-clip1,qv=a1.0,split=test
EVAL_DIR=evaluations/vision/ilharco_timm_supervised/009_qat_transfer_awq/vision/qv_transfer_awq/model=vit_base_patch16_224_orig_in21k/src=CIFAR10-seed2038/tgt=GTSRB-seed2038/optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128/qat=b3-gchannel-shead/awq=b3-gchannel-shead-n4-grid20-clip1/qv=a1.0/split=test
LOG_DIR=logs/vision/ilharco_timm_supervised/009_qat_transfer_awq/qv_transfer_awq/model=vit_base_patch16_224_orig_in21k,src=CIFAR10-seed2038,tgt=GTSRB-seed2038,optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128,qat=b3-gchannel-shead,awq=b3-gchannel-shead-n4-grid20-clip1,qv=a1.0,split=test/wave_20260803-140339
ARTIFACT=evaluations/vision/ilharco_timm_supervised/009_qat_transfer_awq/vision/qv_transfer_awq/model=vit_base_patch16_224_orig_in21k/src=CIFAR10-seed2038/tgt=GTSRB-seed2038/optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128/qat=b3-gchannel-shead/awq=b3-gchannel-shead-n4-grid20-clip1/qv=a1.0/split=test/eval_results.json
