...
This run: `model=vit_base_patch16_224_orig_in21k,src=RESISC45-seed2038,tgt=EMNIST-seed2038,optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128,qat=b3-gchannel-shead,awq=b3-gchannel-shead-n4-grid20-clip1,qv=a1.0,split=test` → rig-4090, gpu 0.
