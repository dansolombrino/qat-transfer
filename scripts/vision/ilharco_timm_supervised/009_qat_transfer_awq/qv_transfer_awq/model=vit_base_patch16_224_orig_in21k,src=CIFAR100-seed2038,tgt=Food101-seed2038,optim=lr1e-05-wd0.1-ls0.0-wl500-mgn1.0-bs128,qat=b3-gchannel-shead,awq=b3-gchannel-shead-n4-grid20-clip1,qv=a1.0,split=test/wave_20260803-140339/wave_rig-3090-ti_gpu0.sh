#!/usr/bin/env bash
# run: model=vit_base_patch16_224_orig_in21k,src=CIFAR100-seed2038,tgt=Food101-seed2038,optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128,qat=b3-gchannel-shead,awq=b3-gchannel-shead-n4-grid20-clip1,qv=a1.0,split=test   experiment: vision/ilharco_timm_supervised/009_qat_transfer_awq
...
RUN_ID_FLAT=model=vit_base_patch16_224_orig_in21k,src=CIFAR100-seed2038,tgt=Food101-seed2038,optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128,qat=b3-gchannel-shead,awq=b3-gchannel-shead-n4-grid20-clip1,qv=a1.0,split=test
EVAL_DIR=evaluations/vision/ilharco_timm_supervised/009_qat_transfer_awq/vision/qv_transfer_awq/model=vit_base_patch16_224_orig_in21k/src=CIFAR100-seed2038/tgt=Food101-seed2038/optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128/qat=b3-gchannel-shead/awq=b3-gchannel-shead-n4-grid20-clip1/qv=a1.0/split=test
LOG_DIR=logs/vision/ilharco_timm_supervised/009_qat_transfer_awq/qv_transfer_awq/model=vit_base_patch16_224_orig_in21k,src=CIFAR100-seed2038,tgt=Food101-seed2038,optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128,qat=b3-gchannel-shead,awq=b3-gchannel-shead-n4-grid20-clip1,qv=a1.0,split=test/wave_20260803-140339
ARTIFACT=evaluations/vision/ilharco_timm_supervised/009_qat_transfer_awq/vision/qv_transfer_awq/model=vit_base_patch16_224_orig_in21k/src=CIFAR100-seed2038/tgt=Food101-seed2038/optim=lr1e-05-wd0.1-ls0.0-wl500-mgn1.0-bs128/qat=b3-gchannel-shead/awq=b3-gchannel-shead-n4-grid20-clip1/qv=a1.0/split=test/eval_results.json
...
HYDRA_ARGS=('model_name="vit_base_patch16_224.orig_in21k"' batch_size=128 'eval_split="test"' limit_num_batches=null log_to_file=false skip_existing=true lr=1e-05 wd=0.1 ls=0.0 wl=500 max_grad_norm=1.0 gpu=0 'source.dataset_names=["CIFAR100"]' source.seed=2038 source.limit_num_epochs=null 'target.dataset_names=["Food101"]' target.seed=2038 target.limit_num_epochs=null qat.bits=3 'qat.granularity="channel"' 'qat.skip_modules=["head"]' 'qv.alphas=[1.0]' 'awq.skip_modules=["head"]' awq.bits=3 'awq.granularity="channel"' awq.num_calib_batches=4 awq.n_grid=20 awq.clip=true)
