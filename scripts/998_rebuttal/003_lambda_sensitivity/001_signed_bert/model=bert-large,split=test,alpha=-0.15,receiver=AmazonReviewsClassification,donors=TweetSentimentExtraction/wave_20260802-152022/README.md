...
Dispatched 2026-08-02 19:52 from rig-4090.
...
This run: `model=bert-large,split=test,alpha=-0.15,receiver=AmazonReviewsClassification,donors=TweetSentimentExtraction` → behemoth, gpu 2.

Full wave: 31 currently materialized runs on behemoth GPUs
