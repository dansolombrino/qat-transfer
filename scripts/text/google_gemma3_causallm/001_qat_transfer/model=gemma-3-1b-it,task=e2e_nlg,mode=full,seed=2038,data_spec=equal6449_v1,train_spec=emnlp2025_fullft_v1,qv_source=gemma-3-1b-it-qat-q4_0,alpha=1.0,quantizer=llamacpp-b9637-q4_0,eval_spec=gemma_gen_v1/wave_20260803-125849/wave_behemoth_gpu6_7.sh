...
exec ./.venv/bin/torchrun --standalone --nproc_per_node=2 \
  ...
  > "logs/text/google_gemma3_causallm/001_qat_transfer/model=gemma-3-1b-it/task=e2e_nlg/mode=full/seed=2038/data_spec=equal6449_v1/train_spec=emnlp2025_fullft_v1/qv_source=gemma-3-1b-it-qat-q4_0/alpha=1.0/quantizer=llamacpp-b9637-q4_0/eval_spec=gemma_gen_v1/wave_20260803-125849/behemoth_gpu6_7.log" 2>&1
