...
def _run_pair_alpha(
    ...
    qat_source_path = os.path.join(
        _qat_ckpt_dir(cfg, source_dataset_name, cfg.source.seed, cfg.source.epoch_mult),
        f"classifier_epoch_{src_epochs}.pt",
    )
    ...
    qat_target_path = os.path.join(
        _qat_ckpt_dir(cfg, target_dataset_name, cfg.target.seed, cfg.target.epoch_mult),
        f"classifier_epoch_{tgt_epochs}.pt",
    )
