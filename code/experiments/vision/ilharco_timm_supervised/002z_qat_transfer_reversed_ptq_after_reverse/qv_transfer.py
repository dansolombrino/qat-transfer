...
def _resolve_alpha(cfg, source_dataset_name, target_dataset_name):
    ...
    best_alpha_path = os.path.join(
        ...
        "vision", "ilharco_timm_supervised", "002z_qat_transfer_reversed_ptq_after_reverse", "vision", "qv_transfer",
        sanitized_model,
...
@hydra.main(
    config_path="../../../../../config/experiments/vision/ilharco_timm_supervised/002z_qat_transfer_reversed_ptq_after_reverse",
