"""001 — QV Transfer Heatmap (ilharco_open_clip)
...
where:
  ...
  cols  = qv datasets      (x-axis)  +  6 baseline columns appended at right
...
def plot_heatmap(data, args, model_dir, optim_frag, qat_frag, qv_frag):
    ...
    title = (
        ...
        f"<sup>{args.model_name}/{args.pretrained} | seed={args.seed} | "
