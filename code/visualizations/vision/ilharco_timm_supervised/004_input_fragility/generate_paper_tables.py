...
def emit_task_stats_table(cfg, args):
    ...
    lines.append(f"% Per-task statistics for {short} at W{args.bits_primary}-{args.granularity} and W{args.bits_secondary}-{args.granularity}.")
    ...
    lines.append(
        ...
        f"$\\dagger$ marks rows excluded at that regime by the eligibility filter "
