"""999 — Donor/Receiver LaTeX Table: QV transfer at best alpha (timm supervised)

Produces a LaTeX table with donor- and receiver-wise transfer statistics
using per-pair best alpha for each timm model.  Columns:
...
def format_latex_table(rows):
    ...
    lines.append(r"\label{tab:donor_receiver_timm_best_alpha}")
