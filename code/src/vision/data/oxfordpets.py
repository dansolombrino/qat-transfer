...
class OxfordIIITPet:
    def __init__(
        ...
        hf_train = load_dataset("timm/oxford-iiit-pet", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("timm/oxford-iiit-pet", split="test", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
