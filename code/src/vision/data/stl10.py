...
class STL10:
    def __init__(
        ...
        hf_train = load_dataset("tanganke/stl10", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("tanganke/stl10", split="test", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
