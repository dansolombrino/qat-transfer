...
class ImageNet:
    def __init__(
        ...
        hf_train = load_dataset(
            "ILSVRC/imagenet-1k", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE
        )
        ...
        hf_test = load_dataset(
            "ILSVRC/imagenet-1k", split="validation", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE
        )
