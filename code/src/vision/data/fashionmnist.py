...
class FashionMNIST:
    def __init__(
        ...
        hf_train = load_dataset("zalando-datasets/fashion_mnist", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("zalando-datasets/fashion_mnist", split="test", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
