...
class Food101:
    def __init__(
        ...
        hf_train = load_dataset("ethz/food101", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("ethz/food101", split="validation", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
