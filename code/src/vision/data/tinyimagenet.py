...
class TinyImageNet:
    def __init__(
        ...
        hf_train = load_dataset("zh-plus/tiny-imagenet", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("zh-plus/tiny-imagenet", split="valid", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
