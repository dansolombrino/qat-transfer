...
class RenderedSST2:
    def __init__(
        ...
        hf_train = load_dataset("nateraw/rendered-sst2", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("nateraw/rendered-sst2", split="test", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
