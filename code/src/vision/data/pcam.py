...
class PCAM:
    def __init__(
        ...
        hf_train = load_dataset("1aurent/PatchCamelyon", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("1aurent/PatchCamelyon", split="test", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
