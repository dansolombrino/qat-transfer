...
class Banking77:
    def __init__(self, batch_size, num_workers, seed):
        ...
        hf_train = load_dataset("mteb/banking77", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
        ...
        hf_test = load_dataset("mteb/banking77", split="test", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE)
