...
class MTOPDomain:
    def __init__(self, batch_size, num_workers, seed):
        ...
        hf_train = load_dataset("mteb/mtop_domain", "en", split="train", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE, trust_remote_code=True, verification_mode="no_checks")
        ...
        hf_test = load_dataset("mteb/mtop_domain", "en", split="test", token=HF_TOKEN, cache_dir=HF_DATASETS_CACHE, trust_remote_code=True, verification_mode="no_checks")
