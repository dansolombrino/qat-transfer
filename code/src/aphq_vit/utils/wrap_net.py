...
def vit_attn_forward(self, x, attn_mask=None, is_causal=False):
    B, N, C = x.shape
    x = self.qkv(x)
...
def wrap_modules_in_net(model, cfg, reparam=False, recon=False, skip_modules=frozenset()):
    quantized_names = []
