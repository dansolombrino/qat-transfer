...
from .calibrator import QuantCalibrator
            ...
            if hasattr(module, 'mode'):
                if isinstance(module, MinMaxQuantLinear) or isinstance(module, MinMaxQuantConv2d):
                    ...
                    if quant_act:
                        ...
                        module.mode = 'raw'
        if len(w_params) == 0:
            # No quantized weight parameters in this block (e.g. head was skipped via
            # skip_modules). Nothing to optimize; release cached tensors and return.
